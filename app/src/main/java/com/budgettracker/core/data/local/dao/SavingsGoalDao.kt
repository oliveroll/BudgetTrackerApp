...
interface SavingsGoalDao {
    ...
    suspend fun getOverdueGoals(userId: String, date: Long): List<SavingsGoalEntity>
    ...
    suspend fun updateGoalAmount(id: String, newAmount: Double, updatedAt: Long = System.currentTimeMillis())
